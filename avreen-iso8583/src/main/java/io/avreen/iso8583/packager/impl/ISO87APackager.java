...
/**
 * The class Iso 87 a packager.
 */
public class ISO87APackager extends ISOMsgBasePackager {
    /**
     * The Fld.
     */
    protected ISOComponentPackager fld[] = {
            ...
            /*028*/ new IFA_NUMERIC(9, "AMOUNT, TRANSACTION FEE"),
            /*029*/ new IFA_NUMERIC(9, "AMOUNT, SETTLEMENT FEE"),
            /*030*/ new IFA_NUMERIC(9, "AMOUNT, TRANSACTION PROCESSING FEE"),
            /*031*/ new IFA_NUMERIC(9, "AMOUNT, SETTLEMENT PROCESSING FEE"),
            ...
            /*097*/ new IFA_NUMERIC(17, "AMOUNT, NET SETTLEMENT"),
    ...
    /**
     * Instantiates a new Iso 87 a packager.
     */
    ...
    public static void main(String[] args) {
        ...
        iso87APackager.unpack(isoMsg, ByteBuffer.wrap(bytes));

        System.out.println(isoMsg);

        {
            ByteBuffer byteBuffer = ByteBuffer.allocate(9999);
            int t = iso87APackager.pack(isoMsg, byteBuffer);
            byte[] bb = new byte[t];
