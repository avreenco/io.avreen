 ...
 * The type Request pin ver ibm multi.
 */
@SafenetFunctionCodeAnnotaion(code = FunctionCodes.PIN_VER_IBM_MULTI)
public class Request_PIN_VER_IBM_MULTI extends RequestBase {
    private String FM;
    ...
    /**
     * Instantiates a new Request pin ver ibm multi.
     */
    public Request_PIN_VER_IBM_MULTI() {
        super();
    }
     ...
     * Gets check len.
     *
     * @return the check len
     */
    public short getCheck_Len() {
        return Check_Len;
    }
     ...
     * Sets check len.
     *
     * @param check_Len the check len
     */
    public void setCheck_Len(short check_Len) {
        Check_Len = check_Len;
    }
